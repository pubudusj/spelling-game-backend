...
class GenerateWordsStateMachineStack(NestedStack):
    ...
    def __init__(
        ...
        **kwargs,
        ...
        prompt = "Generate 5 unique words that has random number of characters more than 5 and less than 10 in {} language. For each word, provide a brief description of its meaning in English. Produce output only in minified JSON array with the keys word and description."
        ...
        save_word_to_dynamodb = tasks.DynamoPutItem(
            ...
            item={
                ...
                "sk": tasks.DynamoAttributeValue.from_string(
                    sfn.JsonPath.string_at("$.output.SynthesisTask.TaskId")
                ),
